...
//*****************COLLIDER
char collider(level_setting_t * levelSettings, object_t ** alienList, object_t ** usrList, object_t ** barrerasList, object_t ** balasEnemigas, object_t ** balasUsr, int nivelActual, int* scoreReal, int* scoreInstantaneo); //Recorre todas las listas para chequear si hubo colisiones
